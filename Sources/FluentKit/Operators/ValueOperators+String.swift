...
public func ~= <Model, Field>(lhs: KeyPath<Model, Field>, rhs: Field.FilterValue) -> ModelValueFilter<Model>
    where Model: FluentKit.Model, Field: FieldProtocol, Field.FilterValue: CustomStringConvertible
{
