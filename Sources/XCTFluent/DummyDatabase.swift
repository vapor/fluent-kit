...
public struct DummyDatabase: Database {
    ...
    public func execute(query: DatabaseQuery, onOutput: @escaping @Sendable (any DatabaseOutput) -> Void) -> EventLoopFuture<Void> {
...
private struct DummyDecoder: Decoder {
    ...
    struct KeyedDecoder<Key: CodingKey>: KeyedDecodingContainerProtocol {
        ...
        func nestedContainer<NestedKey: CodingKey>(keyedBy type: NestedKey.Type, forKey key: Key) throws -> KeyedDecodingContainer<
            NestedKey
        > {
